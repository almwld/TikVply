...
class NotificationsScreen extends StatelessWidget {
              ...
              actions: [
                Consumer<NotificationProvider>(
                  builder: (_, provider, __) => provider.unreadCount > 0
                      ? TextButton(onPressed: provider.markAllAsRead, child: const Text('قراءة الكل'))
  ...
  Widget _emptyState(NotificationProvider provider) => RefreshIndicator(
        onRefresh: provider.loadNotifications,
        child: ListView(
          physics: const AlwaysScrollableScrollPhysics(),
          children: const [
            ...
            Center(
              child: Padding(
                ...
                child: Text('ستظهر هنا الإعجابات والتعليقات والمتابعات عند ربط مصدر التنبيهات الحقيقي.', textAlign: TextAlign.center, style: TextStyle(color: Colors.grey, height: 1.5)),
              ),
            ),
          ],
        ),
