        ...
        body: ListView(
          ...
          children: [
            ...
            Card(child: Column(children: [
              ...
              _switch(Icons.gesture_rounded, 'إيماءات التحكم', 'السحب أفقيًا للتقديم أو الرجوع', video.gesturesEnabled, video.setGesturesEnabled),
            ...
            Card(child: Column(children: [
              ...
              const ListTile(leading: Icon(Icons.storage_outlined, color: AppColors.primary), title: Text('مكتبة الهاتف'), subtitle: Text('يقرأ TikVply ملفات الفيديو التي يسمح بها نظام Android فقط.')),
            ])),
            _section('التطبيق'),
            Card(child: Column(children: [
              ...
              ListTile(leading: const Icon(Icons.info_outline, color: AppColors.primary), title: const Text('حول TikVply'), subtitle: const Text('مشغل فيديو اجتماعي • الإصدار 1.1.0'), trailing: const Icon(Icons.chevron_left), onTap: () => _info(context, 'TikVply', 'مشغل فيديو لاكتشاف وتشغيل وإدارة الوسائط.')),
...
class _BackButton extends StatelessWidget {
  const _BackButton();
  @override
  Widget build(BuildContext context) => IconButton(tooltip: 'رجوع', onPressed: () => Navigator.of(context).maybePop(), icon: const Icon(Icons.arrow_back_rounded));
}
