...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        appBar: TikVplyAppBar(title: 'الملف الشخصي', actions: [
...
class UserProfileScreen extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) => Directionality(textDirection: TextDirection.rtl, child: Scaffold(appBar: const TikVplyAppBar(title: 'الملف الشخصي'), body: Center(child: Text('المستخدم: $userId'))));
}
